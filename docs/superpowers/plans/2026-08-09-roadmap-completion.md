...
- [x] **Step 3: Implement the minimum safe lifecycle path**
...
- [x] **Step 1: Write failing shaping tests**
...
- [x] **Step 3: Implement exact result budgeting and provenance**
...
- [x] **Step 1: Write failing schema and wire tests**
...
- [x] **Step 3: Implement the minimum schema fix**
...
- [x] **Step 5: Resolve OQ-3 and commit**
...
- [x] **Step 1: Write failing CLI/config/E2E tests**
...
- [x] **Step 3: Implement shared binary wiring**
...
- [x] **Step 3: Replace only the product surface**
...
- [x] **Step 4: Validate and run green tests**
...
- [x] **Step 1: Write failing property and dogfood tests**
...
- [x] **Step 3: Update roadmap evidence**
